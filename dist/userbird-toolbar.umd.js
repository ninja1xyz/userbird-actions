(function(o,s){typeof exports=="object"&&typeof module<"u"?s(exports):typeof define=="function"&&define.amd?define(["exports"],s):(o=typeof globalThis<"u"?globalThis:o||self,s(o.UserBirdToolbar={}))})(this,function(o){"use strict";const s=r=>`<svg id="Layer_1" href="${r}" xmlns="http://www.w3.org/2000/svg" version="1.1" height="35" width="120" viewBox="0 0 421.39 96.87" style="margin-right: 10px;">Add commentMore actions
  <defs>
    <style>
      .st0 {
        fill: #fff;
...
`).join("")}
    ...
    `,document.body.appendChild(this.toolbar),this.makeDraggable()}makeDraggable(){this.toolbar.onmousedown=t=>{t.preventDefault();const i=t.clientX-this.toolbar.getBoundingClientRect().left,c=t.clientY-this.toolbar.getBoundingClientRect().top,h=(e,d)=>{this.toolbar.style.left=e-i+"px",this.toolbar.style.top=d-c+"px",this.toolbar.style.right="auto",this.toolbar.style.bottom="auto",this.toolbar.style.position="fixed"},a=e=>h(e.clientX,e.clientY);document.addEventListener("mousemove",a),document.onmouseup=()=>{document.removeEventListener("mousemove",a),document.onmouseup=null}},this.toolbar.ondragstart=()=>!1}async init(){this.setupImports().then(async()=>{this.apiToken=this.getApiTokenFromHash(),console.log(this.apiToken),this.apiToken&&this.siteId&&this.workspaceId&&await this.fetchProfile()?this.createToolbar():console.warn("UserBird Redirection Unauthenticated.")})}}o.UserBirdToolbar=n,o.default=n,Object.defineProperties(o,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
