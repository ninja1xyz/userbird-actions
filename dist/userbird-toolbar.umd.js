(function(t,s){typeof exports=="object"&&typeof module<"u"?s(exports):typeof define=="function"&&define.amd?define(["exports"],s):(t=typeof globalThis<"u"?globalThis:t||self,s(t.UserBirdToolbar={}))})(this,function(t){"use strict";var g=Object.defineProperty;var u=(t,s,i)=>s in t?g(t,s,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[s]=i;var h=(t,s,i)=>u(t,typeof s!="symbol"?s+"":s,i);const s=l=>`<svg id="Layer_1" href="${l}" xmlns="http://www.w3.org/2000/svg" version="1.1" height="35" width="120" viewBox="0 0 421.39 96.87" style="margin-right: 10px;">Add commentMore actions
  <defs>
    <style>
      .st0 {
        fill: #fff;
...
</svg>`,i={Domain:"userbird.com",Environment:"staging",Url:"https://www.staging-api.userbird.com",LogoUrl:"https://www.userbird.com/logo.svg",SiteURL:"https://www.staging.userbird.com",APIUrl:"https://www.staging-api.userbird.com",LogoWidth:"24px",LogoHeight:"24px",LogoAlt:"UserBird Logo",Localhost:"http://localhost:5173"};class a{constructor(){h(this,"cb",e=>{this.apiToken=e.token,this.siteId=e.siteId,this.workspaceId=e.workspaceId,this.init()});this.siteId=null,this.workspaceId=null,this.logoSvg=null,this.apiToken=null,this.toolbar=null,this.logoRender=null,this.config=null}async setupImports(){this.config=i,this.logoSvg=s("www."+this.Domain+"/")}getApiUrl(){return this.config.APIUrl}getSiteUrl(){return this.config.SiteURL}async fetchProfile(){return(await fetch(this.getApiUrl(),{method:"GET",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiToken}})).ok}createToolbar(){this.toolbar=document.createElement("div"),this.toolbar.id="userbird-toolbar",Object.assign(this.toolbar.style,{position:"fixed",bottom:"20px",right:"20px",background:"#222",color:"#fff",padding:"10px 20px",borderRadius:"6px",boxShadow:"0 2px 8px rgba(0,0,0,0.15)",zIndex:"9999",cursor:"move"});const e=`${this.getSiteUrl()}${this.workspaceId}/site/${this.siteId}`;this.toolbar.innerHTML=`
...
`).join("")}
        ...
        |
        <a href="${e}" style="text-decoration:none;color:white;padding-top:5px;margin-left:10px;" target="_blank" rel="noopener noreferrer">
          Dashboard
        </a>
      </div>
    `,document.body.appendChild(this.toolbar),this.makeDraggable()}makeDraggable(){this.toolbar.onmousedown=e=>{e.preventDefault();const o=e.clientX-this.toolbar.getBoundingClientRect().left,r=e.clientY-this.toolbar.getBoundingClientRect().top,d=(n,p)=>{this.toolbar.style.left=n-o+"px",this.toolbar.style.top=p-r+"px",this.toolbar.style.right="auto",this.toolbar.style.bottom="auto",this.toolbar.style.position="fixed"},c=n=>d(n.clientX,n.clientY);document.addEventListener("mousemove",c),document.onmouseup=()=>{document.removeEventListener("mousemove",c),document.onmouseup=null}},this.toolbar.ondragstart=()=>!1}bindEvent(e){e.addEventListener("message",o=>{if(o.origin!==this.config.SiteURL)return;const r=JSON.parse(o.data);console.log(o.data),this.cb(r),o.source.postMessage({type:"RESPONSE",text:"Authenticated!"},o.origin)})}async init(){this.setupImports().then(async()=>{this.apiToken&&this.siteId&&this.workspaceId&&await this.fetchProfile()?this.createToolbar():console.warn("UserBird Redirection Unauthenticated.")})}}t.UserBirdToolbar=a,t.default=a,Object.defineProperties(t,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
