(function(t,s){typeof exports=="object"&&typeof module<"u"?s(exports):typeof define=="function"&&define.amd?define(["exports"],s):(t=typeof globalThis<"u"?globalThis:t||self,s(t.UserBirdToolbar={}))})(this,function(t){"use strict";var g=Object.defineProperty;var u=(t,s,e)=>s in t?g(t,s,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[s]=e;var h=(t,s,e)=>u(t,typeof s!="symbol"?s+"":s,e);const s=l=>`<svg id="Layer_1" href="${l}" xmlns="http://www.w3.org/2000/svg" version="1.1" height="35" width="120" viewBox="0 0 421.39 96.87" style="margin-right: 10px;">Add commentMore actions
  <defs>
    <style>
      .st0 {
        fill: #fff;
...
</svg>`,e={Domain:"userbird.com",Environment:"staging",Url:"https://www.staging-api.userbird.com",LogoUrl:"https://www.userbird.com/logo.svg",LogoWidth:"24px",LogoHeight:"24px",LogoAlt:"UserBird Logo",Localhost:"http://localhost:5173"};class r{constructor(){h(this,"cb",o=>{this.apiToken=o.token,this.siteId=o.siteId,this.workspaceId=o.workspaceId,this.init()});this.siteId=null,this.workspaceId=null,this.logoSvg=null,this.apiToken=null,this.toolbar=null,this.logoRender=null,this.config=null}async setupImports(){this.config=e,this.logoSvg=s("www."+this.Domain+"/")}getApiTokenFromHash(){return new URLSearchParams(window.location.hash.substring(1)).get("birdAuth")}getApiUrl(){return this.config.Environment==="production"?`https://api.${this.config.Domain}/api/profile/`:`https://staging-api.${this.config.Domain}/api/profile/`}getSiteUrl(){return this.config.Environment==="production"?`https://${this.config.Domain}/`:`https://staging.${this.config.Domain}/`}async fetchProfile(){return(await fetch(this.getApiUrl(),{method:"GET",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiToken}})).ok}createToolbar(){this.toolbar=document.createElement("div"),this.toolbar.id="userbird-toolbar",Object.assign(this.toolbar.style,{position:"fixed",bottom:"20px",right:"20px",background:"#222",color:"#fff",padding:"10px 20px",borderRadius:"6px",boxShadow:"0 2px 8px rgba(0,0,0,0.15)",zIndex:"9999",cursor:"move"});const o=`${this.config.Localhost+"/"||this.getSiteUrl()}${this.workspaceId}/site/${this.siteId}`;this.toolbar.innerHTML=`
...
`).join("")}
        ...
        |
        <a href="${o}" style="text-decoration:none;color:white;padding-top:5px;margin-left:10px;" target="_blank" rel="noopener noreferrer">
          Dashboard
        </a>
      </div>
    `,document.body.appendChild(this.toolbar),this.makeDraggable()}makeDraggable(){this.toolbar.onmousedown=o=>{o.preventDefault();const i=o.clientX-this.toolbar.getBoundingClientRect().left,a=o.clientY-this.toolbar.getBoundingClientRect().top,d=(n,p)=>{this.toolbar.style.left=n-i+"px",this.toolbar.style.top=p-a+"px",this.toolbar.style.right="auto",this.toolbar.style.bottom="auto",this.toolbar.style.position="fixed"},c=n=>d(n.clientX,n.clientY);document.addEventListener("mousemove",c),document.onmouseup=()=>{document.removeEventListener("mousemove",c),document.onmouseup=null}},this.toolbar.ondragstart=()=>!1}bindEvent(o){o.addEventListener("message",i=>{const a=JSON.parse(i.data);console.log(i.data),this.cb(a),i.source.postMessage({type:"RESPONSE",text:"Authenticated!"},i.origin)})}async init(){this.setupImports().then(async()=>{this.apiToken=this.apiToken||this.getApiTokenFromHash(),console.log(this.apiToken),this.apiToken&&this.siteId&&this.workspaceId&&await this.fetchProfile()?this.createToolbar():console.warn("UserBird Redirection Unauthenticated.")})}}t.UserBirdToolbar=r,t.default=r,Object.defineProperties(t,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
