(function(e,s){typeof exports=="object"&&typeof module<"u"?s(exports):typeof define=="function"&&define.amd?define(["exports"],s):(e=typeof globalThis<"u"?globalThis:e||self,s(e.UserBirdToolbar={}))})(this,function(e){"use strict";const s=a=>`<svg id="Layer_1" href="${a}" xmlns="http://www.w3.org/2000/svg" version="1.1" height="35" width="120" viewBox="0 0 421.39 96.87" style="margin-right: 10px;">Add commentMore actions
  <defs>
    <style>
      .st0 {
        fill: #fff;
...
</svg>`,l={environment:"staging",url:"https://www.staging-api.userbird.com",domain:"userbird.com"};class n{constructor({siteId:t,workspaceId:i}){this.siteId=t,this.workspaceId=i,this.logoSvg=null,this.apiToken=null,this.toolbar=null,this.logoRender=null,this.config=null}async setupImports(){this.config=l,this.logoSvg=s("www."+this.domain+"/")}getApiTokenFromHash(){return new URLSearchParams(window.location.hash.substring(1)).get("birdAuth")}getApiUrl(){return this.config.environment==="production"?`https://api.${this.config.domain}/api/profile/`:`https://staging-api.${this.config.domain}/api/profile/`}getSiteUrl(){}async fetchProfile(){return(await fetch(this.getApiUrl(),{method:"GET",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiToken}})).ok}createToolbar(){this.toolbar=document.createElement("div"),this.toolbar.id="userbird-toolbar",Object.assign(this.toolbar.style,{position:"fixed",bottom:"20px",right:"20px",background:"#222",color:"#fff",padding:"10px 20px",borderRadius:"6px",boxShadow:"0 2px 8px rgba(0,0,0,0.15)",zIndex:"9999",cursor:"move"});const t=`${this.getSiteUrl()||"http://localhost:5173"}/${this.workspaceId}/site/${this.siteId}`;this.toolbar.innerHTML=`
...
`).join("")}
    ...
    `,document.body.appendChild(this.toolbar),this.makeDraggable()}makeDraggable(){this.toolbar.onmousedown=t=>{t.preventDefault();const i=t.clientX-this.toolbar.getBoundingClientRect().left,c=t.clientY-this.toolbar.getBoundingClientRect().top,h=(o,d)=>{this.toolbar.style.left=o-i+"px",this.toolbar.style.top=d-c+"px",this.toolbar.style.right="auto",this.toolbar.style.bottom="auto",this.toolbar.style.position="fixed"},r=o=>h(o.clientX,o.clientY);document.addEventListener("mousemove",r),document.onmouseup=()=>{document.removeEventListener("mousemove",r),document.onmouseup=null}},this.toolbar.ondragstart=()=>!1}async init(){this.setupImports().then(async()=>{this.apiToken=this.getApiTokenFromHash(),console.log(this.apiToken),this.apiToken&&this.siteId&&this.workspaceId&&await this.fetchProfile()?this.createToolbar():console.warn("UserBird Redirection Unauthenticated.")})}}e.UserBirdToolbar=n,e.default=n,Object.defineProperties(e,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
